...
const categories: { id: string, label: string, icon: string }[] = [
	...
	{ id: 'navigation', label: 'Nav', icon: 'lucide:compass' },
	...
	{ id: 'page', label: 'UPages', icon: 'lucide:layout-template' },
]
...
<template>
	<aside class="w-80 border-r border-neutral-200 dark:border-neutral-800 bg-neutral-50/50 dark:bg-neutral-900/40 flex flex-col h-full shrink-0 select-none">
			...
			<div class="p-3 border-b border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-900">
				...
				<div class="grid grid-cols-3 gap-1 mt-2.5">
					<button
						...
						:key="cat.id"
						class="px-1.5 py-1.5 rounded-md text-[11px] font-medium transition-all flex items-center justify-center gap-1.5 truncate"
						:class="selectedCategory === cat.id ? 'bg-neutral-900 dark:bg-white text-white dark:text-neutral-900 shadow-xs font-semibold' : 'bg-neutral-100 dark:bg-neutral-800/80 text-neutral-600 dark:text-neutral-400 hover:bg-neutral-200 dark:hover:bg-neutral-700 hover:text-neutral-900 dark:hover:text-white'"
		...
		<div
			...
			class="flex flex-col flex-1 min-h-0 p-3 space-y-3 overflow-y-auto"
		>
			<div
